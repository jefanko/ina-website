...
const Services = () => {
  ...
  return (
    <section id="services" className="py-24 bg-gray-50/95 backdrop-blur-sm">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Fade direction="up" cascade damping={0.1} triggerOnce>
              {services.map((service, index) => (
                <div
                  key={index}
                  className="bg-white p-8 hover:shadow-xl transition-all duration-300 group border-t-4 border-transparent hover:border-brand-primary hover:scale-105"
                >
                  <div className="mb-6">
                    <service.icon className="w-16 h-16 text-brand-primary group-hover:scale-110 transition-transform duration-300" />
                  </div>
          ...
          <div className="mt-16 bg-white p-8 md:p-12 border-l-4 border-brand-primary">
